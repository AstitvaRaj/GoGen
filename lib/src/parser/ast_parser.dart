...
class AstParser {
  ...
  AstParser(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  AstParser.fromLookup(
  ...
  ffi.Pointer<ffi.Void> getAstHead(
  ...
  late final _getAstHeadPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Char>)>>('getAstHead');
  late final _getAstHead = _getAstHeadPtr
      .asFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Char>)>();

  ffi.Pointer<ffi.Char> getModFileName(
    ffi.Pointer<ffi.Char> modFileLocation,
  ) {
    return _getModFileName(
      modFileLocation,
    );
  }

  late final _getModFileNamePtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Char> Function(
              ffi.Pointer<ffi.Char>)>>('getModFileName');
  late final _getModFileName = _getModFileNamePtr
      .asFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char>)>();
}
...
class node extends ffi.Struct {
  ...
  external ffi.Pointer<ffi.Void> fieldStruct;
}

class package extends ffi.Struct {
...
class file extends ffi.Struct {
  ...
  external ffi.Pointer<ffi.Void> decl;

  @ffi.Int()
  external int declLen;
}

class funcDecl extends ffi.Struct {
  external ffi.Pointer<ffi.Char> name;

  external ffi.Pointer<ffi.Void> funcTypes;
}

class funcType extends ffi.Struct {
  external ffi.Pointer<ffi.Void> params;

  external ffi.Pointer<ffi.Void> results;
}

class fieldList extends ffi.Struct {
  external ffi.Pointer<ffi.Void> list;

  @ffi.Int()
  external int listLen;
}

class field extends ffi.Struct {
  external ffi.Pointer<ffi.Void> names;

  @ffi.Int()
  external int nameLen;

  external ffi.Pointer<ffi.Void> types;
}

class ident extends ffi.Struct {
  external ffi.Pointer<ffi.Char> name;
}

class valueDecl extends ffi.Struct {
  external ffi.Pointer<ffi.Char> name;
}

class type extends ffi.Struct {
  external ffi.Pointer<ffi.Char> name;

  external ffi.Pointer<ffi.Void> decl;

  @ffi.Int()
  external int declsLength;
}

class genDecl extends ffi.Struct {
  external ffi.Pointer<ffi.Char> token;

  external ffi.Pointer<ffi.Void> specs;

  @ffi.Int()
  external int specsLength;
}

class importSpec extends ffi.Struct {
...
class typeSpec extends ffi.Struct {
  external ffi.Pointer<ffi.Char> name;

  external ffi.Pointer<ffi.Void> types;
}

class structType extends ffi.Struct {
  external ffi.Pointer<ffi.Void> fields;
}
